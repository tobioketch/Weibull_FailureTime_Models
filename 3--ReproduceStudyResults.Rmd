---
title: "Demo Paper Tables & Graphs"
output: pdf_document
header-includes:
...
base::source("2--run_codes/NOT_RUN_RCODES/MethodsAndPackages.R")
# Small Sample Size
base::load("misc/sim_misc_results/ResultsSimMethods_SmallSmpls")

# Large Sample Size
base::load("misc/sim_misc_results/ResultsSimMethods_LargeSmpls")
...
include_graphics("demoPlots/Fig2.jpeg")
```
\newpage
\clearpage
...
include_graphics("demoPlots/Fig3.jpeg")
...
include_graphics("demoPlots/Fig4.jpeg")
```
