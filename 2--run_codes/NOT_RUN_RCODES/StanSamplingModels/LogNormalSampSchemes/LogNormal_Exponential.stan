...
data{
    int<lower=0> n; 
    vector[n] y_n;
    real<lower=0> mu_shape;    // empirical/ bootstrapped mean shape param
    real<lower=0> var_shape;   // empirical var shape param
    real<lower=0> mu_scale;    // empirical mean scale param
